    ...
    public render() {
        ...
        return (
            <form onSubmit={handleSubmit}>
              ...
              <Field name="descripcion" component="textarea" placeholder='Escribe un una descripcioón'
              rows="10" cols="30"
              ...
              {/* {  <Field label='Descripción (*)' placeholder='Escribe un una descripcioón' name='descripcion'  maxLength="5"  type='text' required={true} component={Input} />} */}
                ...
                <Field label='Url web' placeholder=' url' name='urlWeb' type='url' maxLength="50"  component={Input} />
                <Field label='Url Instagram' placeholder=' url' name='urlInstagram' type='url' maxLength="50"  component={Input} />
                <Field label='Url Facebook' placeholder=' url' name='urlFacebook' type='url' maxLength="50"  component={Input} />
                <Field label='Url TripAdvisor' placeholder=' url' name='urlTripAdvisor' type='url' maxLength="50"  component={Input} />
                ...
                <Center>
                    <p className="align-content-center"> Ver todos:</p>
                    <Link to='/app/admin'>Ver panoramas </Link>
                </Center>
            </form>
        )
    }
